 ...
 */
public class CapturePayment extends Operation {

    private final String serviceURL;
    private final boolean isLastCapture;
    ...
    public CapturePayment(String transactionId, String transmissionTime, boolean isLastCapture, int amount, int vatAmount, String vatFormat, String sharedSecret, String serviceUrl) {
    ...
    public String toString() {
        ...
        sb.append(System.lineSeparator() + "    \"isLastCapture\" : \"" + isLastCapture + "\",");
    ...
    public void execute() throws IOException {
        String purchaseURLSuffix = "/transactions/capture";
